...
sym1 = Symptoms()
print(sym1.predict(['itching', 'skin_rash', 'nodal_skin_eruptions', '', '', '', '', '', '', '', '', '', '', '', '', '', '']))
from sklearn.tree import DecisionTreeClassifier

# import tensorflow as tf
import pickle

filename = 'finalized_model2.h5'
mod1 = pickle.load(open(filename, 'rb'))
print(mod1)
# mod1.pred
# mod1.predict([sym1.predict(['itching', 'skin_rash', 'nodal_skin_eruptions', '', '', '', '', '', '', '', '', '', '', '', '', '', ''])])

# model = tf.keras.models.load_model('symptom_based_pred_model_1.h5')
# print(model.summary())